// CC1101 register and strobe definitions (subset needed for RX pipeline)
#pragma once
...
#define CC1101_RX_OVERFLOW_BM 0x80
#define CC1101_RXBYTES_NUM_MASK 0x7F
...
static inline uint8_t cc1101_status_state(uint8_t status)
{
    return (status & CC1101_STATUS_STATE_BM);
}
